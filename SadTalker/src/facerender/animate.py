...
try:
    ...
    _face_enhancer_available = True
except Exception:
    _face_enhancer_available = False
    def enhancer_generator_with_len(*args, **kwargs):
        raise RuntimeError("face enhancer unavailable")
    def enhancer_list(*args, **kwargs):
        raise RuntimeError("face enhancer unavailable")
...
class AnimateFromCoeff():
    ...
    def generate(self, x, video_save_dir, pic_path, crop_info, enhancer=None, background_enhancer=None, preprocess='crop', img_size=256):
        ...
        if enhancer and _face_enhancer_available:
